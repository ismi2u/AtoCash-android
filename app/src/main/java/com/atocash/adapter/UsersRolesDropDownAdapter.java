...
public class UsersRolesDropDownAdapter extends ArrayAdapter {

    private final ArrayList<UserRolesResponse> response;
    private final Context context;

    public UsersRolesDropDownAdapter(Context context, int textViewResourceId,
                                     ArrayList<UserRolesResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getName());
