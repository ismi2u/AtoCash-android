...
public class ProjectsDropDownAdapter extends ArrayAdapter {

    private final ArrayList<ProjectsResponse> statusDropDownResponse;
    private final Context context;

    public ProjectsDropDownAdapter(Context context, int textViewResourceId,
                                   ArrayList<ProjectsResponse> statusDropDownResponse) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(statusDropDownResponse.get(position).getProjectName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(statusDropDownResponse.get(position).getProjectName());
