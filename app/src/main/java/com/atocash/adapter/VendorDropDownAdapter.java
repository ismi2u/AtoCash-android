...
import com.atocash.network.response.VendorDropDownItem;

import java.util.ArrayList;

public class VendorDropDownAdapter extends ArrayAdapter {

    private final ArrayList<VendorDropDownItem> response;
    private final Context context;

    public VendorDropDownAdapter(Context context, int textViewResourceId,
                                 ArrayList<VendorDropDownItem> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getVendorName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getVendorName());
