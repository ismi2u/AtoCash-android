...
import com.atocash.network.response.ExpenseTypeNonProjectResponse;

import java.util.ArrayList;

public class NonProjectExpenseTypesDropDownAdapter extends ArrayAdapter {

    private final ArrayList<ExpenseTypeNonProjectResponse> response;
    private final Context context;

    public NonProjectExpenseTypesDropDownAdapter(Context context, int textViewResourceId,
                                                 ArrayList<ExpenseTypeNonProjectResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getExpenseCategoryName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getExpenseCategoryName());
