...
public class ApprovalDropDownAdapter extends ArrayAdapter {

    private final ArrayList<ApprovalGroupDropDownResponse> response;
    private final Context context;

    public ApprovalDropDownAdapter(Context context, int textViewResourceId,
                                   ArrayList<ApprovalGroupDropDownResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getApprovalGroupCode());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getApprovalGroupCode());
