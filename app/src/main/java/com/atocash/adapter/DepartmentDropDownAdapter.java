...
import com.atocash.network.response.DepartmentDropDownResponse;

import java.util.ArrayList;

public class DepartmentDropDownAdapter extends ArrayAdapter {

    private final ArrayList<DepartmentDropDownResponse> response;
    private final Context context;

    public DepartmentDropDownAdapter(Context context, int textViewResourceId,
                                     ArrayList<DepartmentDropDownResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getDeptDesc());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getDeptDesc());
