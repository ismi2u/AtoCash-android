...
public class TasksDropDownAdapter extends ArrayAdapter {

    private final ArrayList<TasksResponse> taskResponse;
    private final Context context;

    public TasksDropDownAdapter(Context context, int textViewResourceId,
                                ArrayList<TasksResponse> taskResponse) {
        super(context, textViewResourceId, taskResponse);
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(taskResponse.get(position).getTaskName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(taskResponse.get(position).getTaskName());
