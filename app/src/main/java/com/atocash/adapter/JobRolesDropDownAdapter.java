...
public class JobRolesDropDownAdapter extends ArrayAdapter {

    private final ArrayList<JobRolesDropDownResponse> response;
    private final Context context;

    public JobRolesDropDownAdapter(Context context, int textViewResourceId,
                                   ArrayList<JobRolesDropDownResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getRoleCode());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getRoleCode());
