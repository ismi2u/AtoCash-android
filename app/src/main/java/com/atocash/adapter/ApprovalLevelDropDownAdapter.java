...
public class ApprovalLevelDropDownAdapter extends ArrayAdapter {

    private final ArrayList<ApprovalBaseResponse> response;
    private final Context context;

    public ApprovalLevelDropDownAdapter(Context context, int textViewResourceId,
                                        ArrayList<ApprovalBaseResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getLevel());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getLevel());
