...
public class CurrencyDownAdapter extends ArrayAdapter {

    private final ArrayList<CurrencyDropDownResponse> response;
    private final Context context;

    public CurrencyDownAdapter(Context context, int textViewResourceId,
                               ArrayList<CurrencyDropDownResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getCurrencyCode());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getCurrencyCode());
