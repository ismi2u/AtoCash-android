...
public class CommonStringDropDownAdapter extends ArrayAdapter {

    private final ArrayList<String> response;
    private final Context context;

    public CommonStringDropDownAdapter(Context context, int textViewResourceId,
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position));
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position));
