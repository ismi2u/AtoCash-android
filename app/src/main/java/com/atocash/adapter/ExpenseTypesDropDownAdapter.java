...
public class ExpenseTypesDropDownAdapter extends ArrayAdapter {

    private final ArrayList<ExpenseTypeResponse> response;
    private final Context context;

    public ExpenseTypesDropDownAdapter(Context context, int textViewResourceId,
                                       ArrayList<ExpenseTypeResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getExpenseTypeName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getExpenseTypeName());
