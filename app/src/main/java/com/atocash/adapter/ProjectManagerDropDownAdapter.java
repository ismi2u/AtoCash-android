...
public class ProjectManagerDropDownAdapter extends ArrayAdapter {

    private final ArrayList<ProjectManagerResponse> statusDropDownResponse;
    private final Context context;

    public ProjectManagerDropDownAdapter(Context context, int textViewResourceId,
                                         ArrayList<ProjectManagerResponse> statusDropDownResponse) {
