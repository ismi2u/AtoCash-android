...
import com.atocash.network.response.BusinessTypesForDropDownResponseItem;

import java.util.ArrayList;

public class BusinessTypesDropDownAdapter extends ArrayAdapter {

    private final ArrayList<BusinessTypesForDropDownResponseItem> response;
    private final Context context;

    public BusinessTypesDropDownAdapter(Context context, int textViewResourceId,
                                        ArrayList<BusinessTypesForDropDownResponseItem> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getBusinessTypeName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getBusinessTypeName());
