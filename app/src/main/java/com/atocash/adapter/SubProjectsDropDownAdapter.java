...
public class SubProjectsDropDownAdapter extends ArrayAdapter {

    private final ArrayList<SubProjectsResponse> statusDropDownResponse;
    private final Context context;

    public SubProjectsDropDownAdapter(Context context, int textViewResourceId,
                                      ArrayList<SubProjectsResponse> statusDropDownResponse) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(statusDropDownResponse.get(position).getSubProjectName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(statusDropDownResponse.get(position).getSubProjectName());
