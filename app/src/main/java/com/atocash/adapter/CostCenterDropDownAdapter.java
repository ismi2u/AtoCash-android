...
public class CostCenterDropDownAdapter extends ArrayAdapter {

    private final ArrayList<CostCenterDropDownResponse> statusDropDownResponse;
    private final Context context;

    public CostCenterDropDownAdapter(Context context, int textViewResourceId,
                                     ArrayList<CostCenterDropDownResponse> statusDropDownResponse) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(statusDropDownResponse.get(position).getCostCenterCode());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(statusDropDownResponse.get(position).getCostCenterCode());
