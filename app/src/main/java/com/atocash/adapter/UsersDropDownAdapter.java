...
public class UsersDropDownAdapter extends ArrayAdapter {

    private final ArrayList<UsersResponse> response;
    private final Context context;

    public UsersDropDownAdapter(Context context, int textViewResourceId,
                                ArrayList<UsersResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getUserName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getUserName());
