...
public class AssignedProjectsDropDownAdapter extends ArrayAdapter {

    private final ArrayList<AssignedProjectsResponse> response;
    private final Context context;

    public AssignedProjectsDropDownAdapter(Context context, int textViewResourceId,
                                           ArrayList<AssignedProjectsResponse> response) {
    ...
    public View getCustomView(int position, View convertView,
        ...
        statusTv.setText(response.get(position).getProjectName());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        bankNameTv.setText(response.get(position).getProjectName());
