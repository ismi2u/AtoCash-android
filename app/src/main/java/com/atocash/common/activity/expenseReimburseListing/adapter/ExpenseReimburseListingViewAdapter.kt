...
class ExpenseReimburseListingViewAdapter(
            ...
            if(documentIds.isNullOrEmpty()) {
                binding.apply {
                    itemInboxCashAdvanceParent.background = ContextCompat.getDrawable(
                        binding.itemInboxCashAdvanceParent.context, R.drawable.ic_doc_not_attched
                    )
                ...
                binding.apply {
                    itemInboxCashAdvanceParent.background = ContextCompat.getDrawable(
                        binding.itemInboxCashAdvanceParent.context, R.drawable.ic_doc_attched
                    )
                    docAttachedIv.setImageDrawable(
                        ContextCompat.getDrawable(
                    ...
                    val documentSize = items[position].documentIDs.toString().split(",").size.toString()
                    noOfDocsAttached.apply {
                        text = binding.noOfDocsAttached.context.getString(
